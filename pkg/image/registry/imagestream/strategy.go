...
// BeforeCreate checks a number of creation preconditions before PrepareCreate or Validate is called.
...
// AdditionalUpdateTransform handles any transformations required before validation or update.
